#!/bin/bash
# OpenUSD Environment Setup Script Generator
# Creates and installs setup-usd-env.sh to dist/
...
if [ ! -d "${INSTALL_DIR}" ]; then
    ...
    echo "Please run ./04-build.sh first"
    echo "========================================"
    exit 1
fi
...
echo "========================================"
echo "OpenUSD Environment Configured"
echo "========================================"
