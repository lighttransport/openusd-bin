@echo off
REM OpenUSD Environment Setup Script Generator for Windows
REM Creates and installs setup-usd-env.bat to dist\
...
if not exist "%INSTALL_DIR%" (
    ...
    echo Please run 04-build.bat first
    echo ========================================
    exit /b 1
)
...
(
echo @echo off
echo REM OpenUSD Environment Setup Script
